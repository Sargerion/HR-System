...
public interface HrService extends BaseService<Integer, Hr>{
    ...
    Map<Optional<Vacancy>, Map<Optional<String>, Optional<String>>> addVacancy(String vacancyName, String specialtyId, String requireSalary, String workExperience) throws ServiceException;
