...
<c:set var="current_page" value="/jsp/admin/addSpecialty.jsp" scope="request"/>
...
<head>
    ...
    <title><fmt:message key="specialty_form_title"/></title>
</head>
<body>
<c:import url="part/adminHeader.jsp"/>
<c:import url="part/addSpecialtyForm.jsp"/>
