        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="${pageContext.request.contextPath}/jsp/user-finder/changeAvatar.jsp"><h5 style="margin-left: 12px; line-height: 8px; font-weight: normal"><fmt:message key="upload_title"/></h5></a></li>
                    <li>
